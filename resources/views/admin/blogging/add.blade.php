                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section">
                                        <div id="dropzone1" class="pro-ad addcoursepro">
                                            ...
                                            @endif
                                            <form action="admin/blogging/add" method="POST" class="dropzone dropzone-custom needsclick addcourse" id="demo1-upload">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="payment-adress">
                                                            ...
                                                            <a type="submit" href="admin/blogging/list" class="btn btn-primary waves-effect waves-light">cancel</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
