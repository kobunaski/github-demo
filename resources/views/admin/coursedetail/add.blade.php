                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="review-content-section">
                                            <div id="dropzone1" class="pro-ad">
                                                ...
                                                @endif
                                                <form action="admin/coursedetail/add" method="POST" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="form-group">
                                                                <select name="idTutor" class="form-control">
                                                                    <option value="none" selected="" disabled="">Select tutor for course</option>
                                                                    @foreach($user as $us)
                                                            ...
                                                            <div class="form-group">
                                                                <select name="idStudent" class="form-control">
                                                                    <option value="none" selected="" disabled="">Select Student for course</option>
                                                                    @foreach($user as $us)
                                                                        @if($us -> idRole == 4)
                                                                            <option value={{$us -> id}}>{{$us -> name}}</option>
                                                                        @endif
