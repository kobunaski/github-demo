                            ...
                            <div class="card-body border-top">
                                ...
                                <div class="">
                                    <ul class="list-unstyled mb-0">
                                        <li class="mb-2"><i
                                                class="fas fa-fw fa-envelope mr-2"></i>{{$user_login-> email}}</li>
                                        <li class="mb-0"><i class="fas fa-fw fa-phone mr-2"></i>{{$user_login-> phone}}
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="card-body border-top">
                                ...
                                <div class="">
                                    <ul class="mb-0 list-unstyled">
                                        <li class="mb-1"><a target="_blank" href="{{$user_login-> facebook}}"><i
                                                    class="fab fa-fw fa-facebook-square mr-1 facebook-color"></i>Facebook
                                            </a></li>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="media-body ">
                                                            <div class="influencer-profile-data">
                                                                ...
                                                                @endif
                                                                <form action="client/staff/edit/{{$user_login -> id}}"
                                                                      method="POST"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input name="gender" type="text"
                                                                                       class="form-control"
                                                                                       placeholder="gender"
                                                                                       value=@if($user_login -> gender == "M") "Male" @else
                                                                                    "Female" @endif disabled>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <input name="dateOfBirth" type="date"
                                                                                       class="form-control"
                                                                                       placeholder="Email"
                                                                                       value="{{$user_login -> dateOfBirth}}"
                                                                                       disabled>
                                                                            </div>
                                                                            <div class="form-group">
