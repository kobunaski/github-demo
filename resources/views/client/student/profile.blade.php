                            ...
                            <div class="card-body border-top">
                                ...
                                <div class="">
                                    <ul class="mb-0 list-unstyled">
                                        <li class="mb-1"><a href="{{$user_login-> facebook}}"><i
                                                    class="fab fa-fw fa-facebook-square mr-1 facebook-color"></i>Facebook</a>
                                        </li>
                                        <li class="mb-1"><a><i
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="media-body ">
                                                            <div class="influencer-profile-data">
                                                                ...
                                                                @endif
                                                                <form action="client/student/edit/{{$user_login -> id}}"
                                                                      method="POST"
